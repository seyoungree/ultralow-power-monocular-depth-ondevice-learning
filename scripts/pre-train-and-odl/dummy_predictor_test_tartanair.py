...
parser.add_argument( '--saved_mdl_path', type=str, default='./checkpoints/dummy_predictors/micro-tartanair-hard')
...
# tartanair_scenarios_test = ['abandonedfactory', 'abandonedfactory_night', 'amusement', 'carwelding', 'endofworld', 'gascola',
#                         'hospital', 'japanesealley', 'neighborhood', 'ocean', 'office', 'office2', 'oldtown', 'seasidetown',
#                         'seasonsforest', 'seasonsforest_winter', 'soulcity', 'westerndesert']
...
with torch.no_grad():
    for test_data in testloader:
        ...
        test_loss += 0 #test_loss_t;   test_loss_list.append(float(test_loss_t.to('cpu')))
        ...
        run_abs_rel, run_sq_rel, run_rmse, run_rmse_log, run_d1, run_d2, run_d3 = compute_errors_masked_train(test_outputs.to(device), test_depth.to(device))
        run_silog = ScaleInvariantMSELogLoss(test_outputs.to(device), test_depth.to(device), 1.0)
        ...
        max_0_15 = 15.0
        run_abs_rel_15, run_sq_rel_15, run_rmse_15, run_rmse_log_15, run_d1_15, run_d2_15, run_d3_15 = compute_errors_masked_train_max_dpth(test_outputs.to(device), test_depth.to(device), max_0_15)
        run_silog_15 = ScaleInvariantMSELogLoss_max_dpth(test_outputs.to(device), test_depth.to(device), 1.0, max_0_15)
        ...
        max_0_25 = 25.0
        run_abs_rel_25, run_sq_rel_25, run_rmse_25, run_rmse_log_25, run_d1_25, run_d2_25, run_d3_25 = compute_errors_masked_train_max_dpth(test_outputs.to(device), test_depth.to(device), max_0_25)
        run_silog_25 = ScaleInvariantMSELogLoss_max_dpth(test_outputs.to(device), test_depth.to(device), 1.0, max_0_25)
        ...
        max_0_50 = 50.0
        run_abs_rel_50, run_sq_rel_50, run_rmse_50, run_rmse_log_50, run_d1_50, run_d2_50, run_d3_50 = compute_errors_masked_train_max_dpth(test_outputs.to(device), test_depth.to(device), max_0_50)
        run_silog_50 = ScaleInvariantMSELogLoss_max_dpth(test_outputs.to(device), test_depth.to(device), 1.0, max_0_50)
